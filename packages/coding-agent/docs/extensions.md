...
| Package | Purpose |
|---------|---------|
| `@mizuikki/pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@mizuikki/pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@mizuikki/pi-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@mizuikki/pi-coding-agent";
...
```typescript
import { isBashToolResult } from "@mizuikki/pi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@mizuikki/pi-coding-agent";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@mizuikki/pi-coding-agent";
...
```typescript
import { SessionManager } from "@mizuikki/pi-coding-agent";
...
```typescript
import { Type } from "typebox";
import { StringEnum } from "@mizuikki/pi-ai";
...
```typescript
import type { AutocompleteItem } from "@mizuikki/pi-tui";
...
```typescript
import { withFileMutationQueue } from "@mizuikki/pi-coding-agent";
...
**Important:** Use `StringEnum` from `@mizuikki/pi-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
- [read.ts](https://github.com/mizuikki/pi-mono/blob/main/packages/coding-agent/src/core/tools/read.ts) - `ReadToolDetails`
- [bash.ts](https://github.com/mizuikki/pi-mono/blob/main/packages/coding-agent/src/core/tools/bash.ts) - `BashToolDetails`
- [edit.ts](https://github.com/mizuikki/pi-mono/blob/main/packages/coding-agent/src/core/tools/edit.ts)
- [write.ts](https://github.com/mizuikki/pi-mono/blob/main/packages/coding-agent/src/core/tools/write.ts)
- [grep.ts](https://github.com/mizuikki/pi-mono/blob/main/packages/coding-agent/src/core/tools/grep.ts) - `GrepToolDetails`
- [find.ts](https://github.com/mizuikki/pi-mono/blob/main/packages/coding-agent/src/core/tools/find.ts) - `FindToolDetails`
- [ls.ts](https://github.com/mizuikki/pi-mono/blob/main/packages/coding-agent/src/core/tools/ls.ts) - `LsToolDetails`
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@mizuikki/pi-coding-agent";
...
```typescript
import { createBashTool } from "@mizuikki/pi-coding-agent";
...
Tools can provide `renderCall` and `renderResult` for custom TUI display. See [tui.md](tui.md) for the full component API and [tool-execution.ts](https://github.com/mizuikki/pi-mono/blob/main/packages/coding-agent/src/modes/interactive/components/tool-execution.ts) for how tool rows are composed.
...
```typescript
import { keyHint } from "@mizuikki/pi-coding-agent";
...
```typescript
import { Text, Component } from "@mizuikki/pi-tui";
...
```typescript
import { CustomEditor, type ExtensionAPI } from "@mizuikki/pi-coding-agent";
import { matchesKey } from "@mizuikki/pi-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@mizuikki/pi-coding-agent";
