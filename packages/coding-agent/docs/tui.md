...
**Source:** [`@mizuikki/pi-tui`](https://github.com/mizuikki/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@mizuikki/pi-tui";
...
```typescript
import { Container, type Focusable, Input } from "@mizuikki/pi-tui";
...
Import from `@mizuikki/pi-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@mizuikki/pi-tui";
```
...
```typescript
import { matchesKey, Key } from "@mizuikki/pi-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@mizuikki/pi-tui";
...
```typescript
import { getMarkdownTheme } from "@mizuikki/pi-coding-agent";
import { Markdown } from "@mizuikki/pi-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@mizuikki/pi-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@mizuikki/pi-coding-agent";
import { DynamicBorder } from "@mizuikki/pi-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@mizuikki/pi-tui";
...
```typescript
import { BorderedLoader } from "@mizuikki/pi-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@mizuikki/pi-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@mizuikki/pi-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@mizuikki/pi-tui";
...
import { matchesKey, truncateToWidth } from "@mizuikki/pi-tui";
