...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@mizuikki/pi-ai`, `@mizuikki/pi-agent-core`, `@mizuikki/pi-coding-agent`, `@mizuikki/pi-tui`, `typebox`.
